        ...
        <div className='mt-6 flex items-center justify-center gap-3'>
          ...
          {activeItem.href && (
            <a
              ...
              className='text-zinc-400 hover:text-green-600 dark:hover:text-green-400 transition'
    ...
    <div className='relative h-full w-full'>
      <div className='absolute inset-0'>
        {item.imageSrc ? (
          ...
          <div className='flex h-full w-full items-center justify-center bg-zinc-100 dark:bg-zinc-800 text-sm text-zinc-400'>
            Sem imagem
          </div>
        )}
      </div>
