...
export default function CTAFinal() {
  return (
    <section className="py-24 px-6 bg-white dark:bg-zinc-950">
      <FadeIn>
        <div className="max-w-220 mx-auto rounded-3xl py-16 px-10 bg-zinc-900 dark:bg-zinc-800 text-center relative overflow-hidden">
          <div className="absolute -top-15 -right-15 w-55 h-55 rounded-full bg-green-600/12 pointer-events-none" />
          <div className="absolute -bottom-10 -left-10 w-40 h-40 rounded-full bg-amber-600/8 pointer-events-none" />
          ...
          <p className="text-base text-white/55 max-w-115 mx-auto mb-8 leading-relaxed relative">
