    ...
    <footer className="py-8 px-6 border-t border-zinc-200 dark:border-zinc-800 bg-[#F8F7F4] dark:bg-[#0C0C0F]">
      <div className="max-w-[1200px] mx-auto flex flex-wrap justify-between items-center gap-4">
        <div className="flex items-center gap-2">
          <div className="w-[26px] h-[26px] rounded-[7px] bg-green-600 flex items-center justify-center">
            <Code size={13} color="#fff" />
          </div>
          <span className="font-display text-base text-zinc-900 dark:text-zinc-100">{siteConfig.name}</span>
        </div>
